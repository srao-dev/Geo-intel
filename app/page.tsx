...
export default function LandingPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fafafa", color: "#1a1a1a" }}>
      ...
      {/* Nav */}
      <nav style={{ position: "sticky", top: 0, zIndex: 100, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 32px", height: 56, background: "rgba(255,255,255,0.92)", backdropFilter: "blur(12px)", borderBottom: "1px solid #e5e7eb" }}>
      ...
      <section style={{ padding: "80px 8% 80px", maxWidth: 1400, margin: "0 auto", display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 80, alignItems: "center" }}>
        <div>
          ...
          <h1 style={{ fontSize: "clamp(44px,5vw,68px)", fontWeight: 900, letterSpacing: "-0.04em", lineHeight: 1.05, marginBottom: 20, color: "#111827" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 28 }}>
          ...
          <div style={{ background: "#0f1117", borderRadius: 20, padding: 24, border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 32px 80px rgba(0,0,0,0.18)", width: "100%" }}>
            {/* Header */}
      ...
      <section id="how-it-works" style={{ padding: "60px 5% 56px", maxWidth: 1280, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <div style={{ fontSize: 12, fontWeight: 800, color: "#3B5BDB", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 8 }}>How it works</div>
      ...
      <section style={{ padding: "0 5% 56px", maxWidth: 1280, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <div style={{ fontSize: 12, fontWeight: 800, color: "#3B5BDB", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 8 }}>Features</div>
