...
export function ShareOfVoice({ data, loading }: ShareOfVoiceProps) {
  ...
  return (
    <div className="flex flex-col gap-3 rounded-xl border border-border border-t-4 border-t-purple-400 bg-card p-4 shadow-sm">
      <div>
        <p className="text-sm font-semibold text-card-foreground">Share of Voice</p>
